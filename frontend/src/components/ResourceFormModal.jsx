...
const ResourceFormModal = ({ isOpen, resource, onClose, onSuccess }) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-slate-700 rounded-md px-3 py-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors forced-color-adjust-none"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-slate-700 rounded-md px-3 py-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors"
              />
            </div>
